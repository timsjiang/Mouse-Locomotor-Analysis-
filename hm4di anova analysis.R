...
library(ggsci)
#visualize data
ggplot(masterDf, aes(x=Dose, y= Count)) + geom_point()+ geom_line(aes(group=Subject))
  scale_y_log10() + scale_color_npg() + xlab ("Dose Dexmedetomidine (mg/kg)") + ylab ("Normalized Counts") + title 
